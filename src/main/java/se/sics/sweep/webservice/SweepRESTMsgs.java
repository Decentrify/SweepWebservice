 ...
 */
package se.sics.sweep.webservice;
...
import se.sics.sweep.webservice.model.AddEntryJSON;
import se.sics.sweep.webservice.model.EntryPlusJSON;
import se.sics.sweep.webservice.model.SearchIndexJSON;
import se.sics.sweep.webservice.toolbox.Result;
import se.sics.sweep.webservice.util.ResponseStatusWSMapper;
...
public class SweepRESTMsgs {
    ...
    static class ProcessAddEntry {
        ...
        public static Result process(IndexEntry entry, SweepSyncI sweep) {
            SettableFuture<se.sics.sweep.webservice.toolbox.Result> opFuture = SettableFuture.create();
